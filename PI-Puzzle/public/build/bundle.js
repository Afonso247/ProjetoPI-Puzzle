...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 33, 1, 655);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "svelte-e03egl");
    			add_location(button, file$4, 32, 0, 631);
    		},
    ...
    /* src/Jogar.svelte generated by Svelte v3.46.0 */
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$3, 133, 5, 3962);
    			attr_dev(td, "id", `${/*i*/ ctx[15]}-${/*j*/ ctx[18]}`);
    			add_location(td, file$3, 131, 4, 3881);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(tr, file$3, 129, 2, 3844);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$3, 115, 0, 3499);
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$3, 120, 0, 3586);
    			set_style(h11, "color", "white");
    			add_location(h11, file$3, 122, 0, 3665);
    			add_location(table, file$3, 127, 0, 3793);
    			add_location(br, file$3, 140, 0, 4034);
    			add_location(p, file$3, 145, 0, 4106);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let tabelaReal = [
    		[
    			"/images/division/1.jpg",
    			"/images/division/2.jpg",
    			"/images/division/3.jpg",
    			"/images/division/4.jpg",
    			"/images/division/5.jpg",
    			"/images/division/6.jpg"
    		],
    		[
    			"/images/division/7.jpg",
    			"/images/division/8.jpg",
    			"/images/division/9.jpg",
    			"/images/division/10.jpg",
    			"/images/division/11.jpg",
    			"/images/division/12.jpg"
    		],
    		[
    			"/images/division/13.jpg",
    			"/images/division/14.jpg",
    			"/images/division/15.jpg",
    			"/images/division/16.jpg",
    			"/images/division/17.jpg",
    			"/images/division/18.jpg"
    		]
    	];
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 9, 1, 154);
    			...
    			add_location(img0, file$2, 13, 1, 187);
    			add_location(p0, file$2, 14, 1, 245);
    			add_location(p1, file$2, 17, 1, 298);
    			...
    			add_location(img1, file$2, 21, 1, 349);
    			add_location(p2, file$2, 22, 1, 408);
    			add_location(p3, file$2, 25, 1, 454);
    			...
    			add_location(img2, file$2, 29, 1, 505);
    			add_location(p4, file$2, 30, 1, 562);
    			add_location(p5, file$2, 33, 1, 604);
    			...
    			add_location(img3, file$2, 37, 1, 655);
    			add_location(p6, file$2, 38, 1, 710);
    			add_location(p7, file$2, 41, 1, 753);
    			...
    			add_location(img4, file$2, 45, 1, 804);
    			add_location(p8, file$2, 46, 1, 865);
    			add_location(p9, file$2, 49, 1, 909);
    			set_style(p10, "margin-top", "80px");
    			add_location(p10, file$2, 55, 1, 962);
    			attr_dev(h2, "class", "about");
    			add_location(h2, file$2, 60, 1, 1117);
    			attr_dev(p11, "id", "text");
    			add_location(p11, file$2, 64, 1, 1234);
    			add_location(body, file$2, 8, 0, 146);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 8, 0, 149);
    			add_location(p0, file$1, 11, 4, 176);
    			if (!src_url_equal(img.src, img_src_value = "images/ayaka.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Uma imagem.");
    			attr_dev(img, "width", "300");
    			attr_dev(img, "height", "400");
    			add_location(img, file$1, 16, 4, 357);
    			add_location(p1, file$1, 18, 4, 438);
    			add_location(p2, file$1, 23, 4, 571);
    			add_location(h2, file$1, 28, 4, 770);
    			add_location(body, file$1, 10, 0, 165);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 10, 1, 191);
    			attr_dev(div0, "class", "menu");
    			add_location(div0, file, 15, 2, 256);
    			attr_dev(button0, "type", "button");
    			add_location(button0, file, 14, 1, 231);
    			attr_dev(div1, "class", "menu");
    			add_location(div1, file, 21, 2, 375);
    			attr_dev(button1, "type", "button");
    			add_location(button1, file, 20, 1, 350);
    			attr_dev(div2, "class", "menu");
    			add_location(div2, file, 27, 2, 495);
    			attr_dev(button2, "type", "button");
    			add_location(button2, file, 26, 1, 470);
    			add_location(body, file, 9, 0, 183);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => trocarStateDoJogo('jogar');
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Jogo: Jogar, Sobre, Ajuda, Menu, state, $state });
    	return [$state];
    }
