...
var app = (function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 33, 1, 655);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "svelte-e03egl");
    			add_location(button, file$8, 32, 0, 631);
    		},
    ...
    const file$7 = "src/JogarA.svelte";
    ...
    function create_each_block_1$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$7, 133, 5, 3998);
    			attr_dev(td, "id", `${/*i*/ ctx[15]}-${/*j*/ ctx[18]}`);
    			add_location(td, file$7, 131, 4, 3917);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(tr, file$7, 129, 2, 3880);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$7, 1, 1, 15);
    			set_style(h10, "color", "white");
    			add_location(h10, file$7, 115, 0, 3535);
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$7, 120, 0, 3622);
    			set_style(h11, "color", "white");
    			add_location(h11, file$7, 122, 0, 3701);
    			add_location(table, file$7, 127, 0, 3829);
    			add_location(br, file$7, 140, 0, 4070);
    			add_location(p, file$7, 145, 0, 4142);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function validar$3(tabela, tabelaReal) {
    	let checkin = 0;
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	function atualizarTabela() {
    		...
    		validar$3(tabela, tabelaReal);
    	}

    	embaralhar$3(tabela); // Ativa a função do embaralhamento
    	const writable_props = [];
    ...
    const file$6 = "src/JogarB.svelte";
    ...
    function create_each_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*dado*/ ctx[16])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$6, 135, 5, 4840);
    			attr_dev(td, "id", `${/*i*/ ctx[15]}-${/*j*/ ctx[18]}`);
    			add_location(td, file$6, 133, 4, 4759);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, img);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(tr, file$6, 131, 2, 4722);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(h10, "color", "white");
    			add_location(h10, file$6, 117, 0, 4377);
    			set_style(img, "width", "50%");
    			set_style(img, "margin-bottom", "50px");
    			if (!src_url_equal(img.src, img_src_value = "/images/ayaka.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$6, 122, 0, 4464);
    			set_style(h11, "color", "white");
    			add_location(h11, file$6, 124, 0, 4543);
    			add_location(table, file$6, 129, 0, 4671);
    			add_location(br, file$6, 142, 0, 4912);
    			add_location(p, file$6, 147, 0, 4984);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "src/JogarC.svelte";
    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*dado*/ ctx[16])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$5, 137, 5, 5834);
    			attr_dev(td, "id", `${/*i*/ ctx[15]}-${/*j*/ ctx[18]}`);
    			add_location(td, file$5, 135, 4, 5753);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, img);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(tr, file$5, 133, 2, 5716);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(h10, "color", "white");
    			add_location(h10, file$5, 119, 0, 5371);
    			set_style(img, "width", "50%");
    			set_style(img, "margin-bottom", "50px");
    			if (!src_url_equal(img.src, img_src_value = "/images/ayaka.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$5, 124, 0, 5458);
    			set_style(h11, "color", "white");
    			add_location(h11, file$5, 126, 0, 5537);
    			add_location(table, file$5, 131, 0, 5665);
    			add_location(br, file$5, 144, 0, 5906);
    			add_location(p, file$5, 149, 0, 5978);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/JogarD.svelte generated by Svelte v3.46.0 */
    const file$4 = "src/JogarD.svelte";
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*dado*/ ctx[16])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$4, 139, 5, 7035);
    			attr_dev(td, "id", `${/*i*/ ctx[15]}-${/*j*/ ctx[18]}`);
    			add_location(td, file$4, 137, 4, 6954);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(137:3) {#each linha as dado, j}",
    		ctx
    	});
    ...
    // (135:1) {#each estadoTabela.tabela as linha, i}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(tr, file$4, 135, 2, 6917);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(135:1) {#each estadoTabela.tabela as linha, i}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(h10, "color", "white");
    			add_location(h10, file$4, 121, 0, 6572);
    			set_style(img, "width", "50%");
    			set_style(img, "margin-bottom", "50px");
    			if (!src_url_equal(img.src, img_src_value = "/images/ayaka.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$4, 126, 0, 6659);
    			set_style(h11, "color", "white");
    			add_location(h11, file$4, 128, 0, 6738);
    			add_location(table, file$4, 133, 0, 6866);
    			add_location(br, file$4, 146, 0, 7107);
    			add_location(p, file$4, 151, 0, 7179);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let tabelaReal = [
    		[
    			"/images/divisionD/1.jpg",
    			"/images/divisionD/2.jpg",
    			"/images/divisionD/3.jpg",
    			"/images/divisionD/4.jpg",
    			"/images/divisionD/5.jpg",
    			"/images/divisionD/6.jpg",
    			"/images/divisionD/7.jpg",
    			"/images/divisionD/8.jpg",
    			"/images/divisionD/9.jpg",
    			"/images/divisionD/10.jpg",
    			"/images/divisionD/11.jpg",
    			"/images/divisionD/12.jpg"
    		],
    		[
    			"/images/divisionD/13.jpg",
    			"/images/divisionD/14.jpg",
    			"/images/divisionD/15.jpg",
    			"/images/divisionD/16.jpg",
    			"/images/divisionD/17.jpg",
    			"/images/divisionD/18.jpg",
    			"/images/divisionD/19.jpg",
    			"/images/divisionD/20.jpg",
    			"/images/divisionD/21.jpg",
    			"/images/divisionD/22.jpg",
    			"/images/divisionD/23.jpg",
    			"/images/divisionD/24.jpg"
    		],
    		[
    			"/images/divisionD/25.jpg",
    			"/images/divisionD/26.jpg",
    			"/images/divisionD/27.jpg",
    			"/images/divisionD/28.jpg",
    			"/images/divisionD/29.jpg",
    			"/images/divisionD/30.jpg",
    			"/images/divisionD/31.jpg",
    			"/images/divisionD/32.jpg",
    			"/images/divisionD/33.jpg",
    			"/images/divisionD/34.jpg",
    			"/images/divisionD/35.jpg",
    			"/images/divisionD/36.jpg"
    		],
    		[
    			"/images/divisionD/37.jpg",
    			"/images/divisionD/38.jpg",
    			"/images/divisionD/39.jpg",
    			"/images/divisionD/40.jpg",
    			"/images/divisionD/41.jpg",
    			"/images/divisionD/42.jpg",
    			"/images/divisionD/43.jpg",
    			"/images/divisionD/44.jpg",
    			"/images/divisionD/45.jpg",
    			"/images/divisionD/46.jpg",
    			"/images/divisionD/47.jpg",
    			"/images/divisionD/48.jpg"
    		],
    		[
    			"/images/divisionD/49.jpg",
    			"/images/divisionD/50.jpg",
    			"/images/divisionD/51.jpg",
    			"/images/divisionD/52.jpg",
    			"/images/divisionD/53.jpg",
    			"/images/divisionD/54.jpg",
    			"/images/divisionD/55.jpg",
    			"/images/divisionD/56.jpg",
    			"/images/divisionD/57.jpg",
    			"/images/divisionD/58.jpg",
    			"/images/divisionD/59.jpg",
    			"/images/divisionD/60.jpg"
    		],
    		[
    			"/images/divisionD/61.jpg",
    			"/images/divisionD/62.jpg",
    			"/images/divisionD/63.jpg",
    			"/images/divisionD/64.jpg",
    			"/images/divisionD/65.jpg",
    			"/images/divisionD/66.jpg",
    			"/images/divisionD/67.jpg",
    			"/images/divisionD/68.jpg",
    			"/images/divisionD/69.jpg",
    			"/images/divisionD/70.jpg",
    			"/images/divisionD/71.jpg",
    			"/images/divisionD/72.jpg"
    		]
    	];
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<JogarD> was created with unknown prop '${key}'`);
    	});
    ...
    class JogarD extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			div3.textContent = "Muito Difícil";
    			t10 = space();
    			create_component(voltarmenu.$$.fragment);
    			attr_dev(link, "rel", "stylesheet");
    			...
    			add_location(div2, file, 28, 2, 567);
    			attr_dev(button2, "type", "button");
    			add_location(button2, file, 27, 1, 542);
    			attr_dev(div3, "class", "dificuldade");
    			add_location(div3, file, 34, 2, 726);
    			attr_dev(button3, "type", "button");
    			set_style(button3, "margin-bottom", "100px");
    			add_location(button3, file, 33, 1, 671);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler_3 = () => trocarStateDoJogo('jogarD');
    ...
    function create_if_block_7(ctx) {
    	let jogod;
    	let current;
    	jogod = new JogarD({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(jogod.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(jogod, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(jogod.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(jogod.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(jogod, detaching);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*$state*/ ctx[0] === "jogarD") return 7;
    		return -1;
    	}
